...
class User extends CI_Controller
{
    ...
    public function kuesioner_dsn_s1_ganjil()
    {
        if ($this->session->userdata('status') !== "dosen") {
            redirect($_SERVER['HTTP_REFERER']);
        }
        ...
        $submit = $this->db->get_where('submit_dsn_s1_20211', ['id_dsn' => $this->session->userdata('nip')])->row_array();

        if ($submit != NULL) {
            $data['matkul'] = $this->db->distinct()->select('jadwal_s1_20211.kode_mk, jadwal_s1_20211.kelas')->from('jadwal_s1_20211')
                ->where('jadwal_s1_20211.id_dsn=' . $this->session->userdata('nip') . '')
                ->where("NOT EXISTS 
                (SELECT submit_dsn_s1_20211.kode_mk, submit_dsn_s1_20211.kelas from submit_dsn_s1_20211 
                WHERE submit_dsn_s1_20211.kelas = jadwal_s1_20211.kelas AND submit_dsn_s1_20211.kode_mk = jadwal_s1_20211.kode_mk AND jadwal_s1_20211.id_dsn=" . $this->session->userdata('nip') . ")")
                ->get()->result();
        } else {
            $data['matkul'] = $this->db->select('matkul_s1_20211.nama_mk, matkul_s1_20211.kode_mk, jadwal_s1_20211.kelas')->from('matkul_s1_20211')
                ->join('jadwal_s1_20211', 'jadwal_s1_20211.kode_mk = matkul_s1_20211.kode_mk', 'left')
                ->where('jadwal_s1_20211.id_dsn=' . $this->session->userdata('nip') . '')
                ->group_by('matkul_s1_20211.kode_mk, jadwal_s1_20211.kelas')
                ->order_by('matkul_s1_20211.kode_mk, jadwal_s1_20211.kelas')
                ->get()->result();
        }
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('user/kuesioner_dsn_s1_ganjil', $data);
        } else {
            $jml_dsn = $this->input->post('jwb1') + $this->input->post('jwb2') + $this->input->post('jwb3') + $this->input->post('jwb4') + $this->input->post('jwb5') + $this->input->post('jwb6') +
                $this->input->post('jwb7') + $this->input->post('jwb8') + $this->input->post('jwb9') + $this->input->post('jwb10') + $this->input->post('jwb11') + $this->input->post('jwb12') + $this->input->post('jwb13') + $this->input->post('jwb14') + $this->input->post('jwb15');
            $indeks_kml_dsn = $jml_dsn / 15;
            ...
            $this->db->insert('submit_dsn_s1_20211', $data);
    ...
    public function kuesioner_dsn_s1_genap()
    {
        if ($this->session->userdata('status') !== "dosen") {
            redirect($_SERVER['HTTP_REFERER']);
        }
        ...
        $submit = $this->db->get_where('submit_dsn_s1_20212', ['id_dsn' => $this->session->userdata('nip')])->row_array();

        if ($submit != NULL) {
            $data['matkul'] = $this->db->distinct()->select('jadwal_s1_20212.kode_mk, jadwal_s1_20212.kelas')->from('jadwal_s1_20212')
                ->where('jadwal_s1_20212.id_dsn=' . $this->session->userdata('nip') . '')
                ->where("NOT EXISTS 
                (SELECT submit_dsn_s1_20212.kode_mk, submit_dsn_s1_20212.kelas from submit_dsn_s1_20212 
                WHERE submit_dsn_s1_20212.kelas = jadwal_s1_20212.kelas AND submit_dsn_s1_20212.kode_mk = jadwal_s1_20212.kode_mk AND jadwal_s1_20212.id_dsn=" . $this->session->userdata('nip') . ")")
                ->get()->result();
        } else {
            $data['matkul'] = $this->db->select('matkul_s1_20212.nama_mk, matkul_s1_20212.kode_mk, jadwal_s1_20212.kelas')->from('matkul_s1_20212')
                ->join('jadwal_s1_20212', 'jadwal_s1_20212.kode_mk = matkul_s1_20212.kode_mk', 'left')
                ->where('jadwal_s1_20212.id_dsn=' . $this->session->userdata('nip') . '')
                ->group_by('matkul_s1_20212.kode_mk, jadwal_s1_20212.kelas')
                ->order_by('matkul_s1_20212.kode_mk, jadwal_s1_20212.kelas')
                ->get()->result();
        }
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('user/kuesioner_dsn_s1_genap', $data);
        } else {
            $jml_dsn = $this->input->post('jwb1') + $this->input->post('jwb2') + $this->input->post('jwb3') + $this->input->post('jwb4') + $this->input->post('jwb5') + $this->input->post('jwb6') +
                $this->input->post('jwb7') + $this->input->post('jwb8') + $this->input->post('jwb9') + $this->input->post('jwb10') + $this->input->post('jwb11') + $this->input->post('jwb12') + $this->input->post('jwb13') + $this->input->post('jwb14') + $this->input->post('jwb15');
            $indeks_kml_dsn = $jml_dsn / 15;
            ...
            $this->db->insert('submit_dsn_s1_20212', $data);

            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Penilaian Anda telah berhasil di Submit.</div>');
            redirect('user/kuesioner_dsn_s1_genap');
        }
    }
    ...
    public function kuelp2m_dsn_s1_ganjil()
    {
        if ($this->session->userdata('status') !== "dosen") {
            redirect($_SERVER['HTTP_REFERER']);
        }
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('user/kuelp2m_dsn_s1_ganjil', $data);
        } else {
            $jml_lp2m = $this->input->post('jwb1') + $this->input->post('jwb2') + $this->input->post('jwb3') + $this->input->post('jwb4') + $this->input->post('jwb5') + $this->input->post('jwb6') +
                $this->input->post('jwb7') + $this->input->post('jwb8') + $this->input->post('jwb9') + $this->input->post('jwb10') + $this->input->post('jwb11') + $this->input->post('jwb12') + $this->input->post('jwb13') + $this->input->post('jwb14') + $this->input->post('jwb15');
            $indeks_kml_lp2m = $jml_lp2m / 15;
            ...
            $this->db->insert('submit_lp2m_s1_20211', $data);

            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Penilaian Anda telah berhasil di Submit.</div>');

            redirect('user/kuelp2m_dsn_s1_ganjil');
        }
    }

    public function kuelp2m_dsn_s1_genap()
    {
        if ($this->session->userdata('status') !== "dosen") {
            redirect($_SERVER['HTTP_REFERER']);
        }
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('user/kuelp2m_dsn_s1_genap', $data);
        } else {
            $jml_lp2m = $this->input->post('jwb1') + $this->input->post('jwb2') + $this->input->post('jwb3') + $this->input->post('jwb4') + $this->input->post('jwb5') + $this->input->post('jwb6') +
                $this->input->post('jwb7') + $this->input->post('jwb8') + $this->input->post('jwb9') + $this->input->post('jwb10') + $this->input->post('jwb11') + $this->input->post('jwb12') + $this->input->post('jwb13') + $this->input->post('jwb14') + $this->input->post('jwb15');
            $indeks_kml_lp2m = $jml_lp2m / 15;
            ...
            $this->db->insert('submit_lp2m_s1_20212', $data);

            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Penilaian Anda telah berhasil di Submit.</div>');

            redirect('user/kuelp2m_dsn_s1_genap');
        }
    }
    ...
    public function kuefkl_dsn_s1_ganjil()
    {
        if ($this->session->userdata('status') !== "dosen") {
            redirect($_SERVER['HTTP_REFERER']);
        }
        ...
        $submit = $this->db->get_where('submit_fkl_s1_20211', ['id_dsn' => $this->session->userdata('nip')])->row_array();
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('user/kuefkl_dsn_s1_ganjil', $data);
        } else {
            $jml_fkl = $this->input->post('jwb1') + $this->input->post('jwb2') + $this->input->post('jwb3') + $this->input->post('jwb4') + $this->input->post('jwb5') + $this->input->post('jwb6') +
                $this->input->post('jwb7') + $this->input->post('jwb8') + $this->input->post('jwb9') + $this->input->post('jwb10') + $this->input->post('jwb11') + $this->input->post('jwb12') +
                $this->input->post('jwb13') + $this->input->post('jwb14') + $this->input->post('jwb15') + $this->input->post('jwb16') + $this->input->post('jwb17') + $this->input->post('jwb18')
            ...
            $this->db->insert('submit_fkl_s1_20211', $data);
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Penilaian Anda telah berhasil di Submit.</div>');
            redirect('user/kuefkl_dsn_s1_ganjil');
        }
    }

    public function kuefkl_dsn_s1_genap()
    {
        if ($this->session->userdata('status') !== "dosen") {
            redirect($_SERVER['HTTP_REFERER']);
        }
        ...
        $submit = $this->db->get_where('submit_fkl_s1_20212', ['id_dsn' => $this->session->userdata('nip')])->row_array();
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('user/kuefkl_dsn_s1_genap', $data);
        } else {
            $jml_fkl = $this->input->post('jwb1') + $this->input->post('jwb2') + $this->input->post('jwb3') + $this->input->post('jwb4') + $this->input->post('jwb5') + $this->input->post('jwb6') +
                $this->input->post('jwb7') + $this->input->post('jwb8') + $this->input->post('jwb9') + $this->input->post('jwb10') + $this->input->post('jwb11') + $this->input->post('jwb12') +
                $this->input->post('jwb13') + $this->input->post('jwb14') + $this->input->post('jwb15') + $this->input->post('jwb16') + $this->input->post('jwb17') + $this->input->post('jwb18')
            ...
            $this->db->insert('submit_fkl_s1_20212', $data);
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Penilaian Anda telah berhasil di Submit.</div>');
            redirect('user/kuefkl_dsn_s1_genap');
        }
    }
    ...
    public function kuebku_dsn_s1_ganjil()
    {
        if ($this->session->userdata('status') !== "dosen") {
            redirect($_SERVER['HTTP_REFERER']);
        }
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('user/kuebku_dsn_s1_ganjil', $data);
        } else {
            // var_dump($this->input->post());
            // die();
            $jml_dsn = $this->input->post('jwb_1') + $this->input->post('jwb_2') + $this->input->post('jwb_3') + $this->input->post('jwb_4') + $this->input->post('jwb_5') + $this->input->post('jwb_6') +
    ...
    public function kuebku_dsn_s1_genap()
    {
        if ($this->session->userdata('status') !== "dosen") {
            redirect($_SERVER['HTTP_REFERER']);
        }
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('user/kuebku_dsn_s1_genap', $data);
        } else {
            // var_dump($this->input->post());
            // die();
            $jml_dsn = $this->input->post('jwb_1') + $this->input->post('jwb_2') + $this->input->post('jwb_3') + $this->input->post('jwb_4') + $this->input->post('jwb_5') + $this->input->post('jwb_6') +
    ...
    public function kuevimi_dsn_s1_ganjil()
    {
        if ($this->session->userdata('status') !== "dosen") {
            redirect($_SERVER['HTTP_REFERER']);
        }
        ...
        $this->form_validation->set_rules('1', 'NIP', 'required|trim');
        if ($this->form_validation->run() == false) {
            $this->load->view('user/kuevimi_dsn_s1_ganjil', $data);
        } else {
            foreach ($this->input->post() as $key => $value) {
                if ($key == 3) {
                    foreach ($this->input->post('3') as $key2 => $value2) {
                        $this->db->insert('submit_vimi_dsn_s1_20211', [
                            'nip' => $this->input->post('nip'),
                            'id_pertanyaan' => $key,
                            'id_jawaban' => $value2,
                        ]);
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Penilaian Anda telah berhasil di Submit.</div>');
            redirect('user/kuevimi_dsn_s1_ganjil');
        }
    }

    public function kuevimi_dsn_s1_genap()
    {
        if ($this->session->userdata('status') !== "dosen") {
            redirect($_SERVER['HTTP_REFERER']);
        }
        ...
        $this->form_validation->set_rules('1', 'NIP', 'required|trim');
        if ($this->form_validation->run() == false) {
            $this->load->view('user/kuevimi_dsn_s1_genap', $data);
        } else {
            foreach ($this->input->post() as $key => $value) {
                if ($key == 3) {
                    foreach ($this->input->post('3') as $key2 => $value2) {
                        $this->db->insert('submit_vimi_dsn_s1_20212', [
                            'nip' => $this->input->post('nip'),
                            'id_pertanyaan' => $key,
                            'id_jawaban' => $value2,
                        ]);
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Penilaian Anda telah berhasil di Submit.</div>');
            redirect('user/kuevimi_dsn_s1_genap');
        }
    }
    ...
    public function kuevimi_tendik()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            foreach ($this->input->post() as $key => $value) {
                if ($key == 3) {
                    foreach ($this->input->post('3') as $key2 => $value2) {
                        $this->db->insert('submit_vimi_tendik', [
                            'nip' => $this->input->post('nip'),
                            'id_pertanyaan' => $key,
                            'id_jawaban' => $value2,
                        ]);
    ...
    public function getNamaMatkul_dsn_s1_ganjil()
    {
        $idmatkul = $this->input->post('idmatkul');
        $string = explode('-', $idmatkul);
        $kode_mk = $string[0];
        $kelas_mk = $string[1];
        $matakuliah = $this->db->select('*')->from('matkul_s1_20211')
            ->join('jadwal_s1_20211', 'jadwal_s1_20211.kode_mk=matkul_s1_20211.kode_mk')
            ->join('dosen', 'dosen.id_dsn = jadwal_s1_20211.id_dsn')
            ->where('jadwal_s1_20211.kode_mk', $kode_mk)->where('jadwal_s1_20211.kelas', $kelas_mk)->where('jadwal_s1_20211.id_dsn', $this->session->userdata('nip'))->get()->first_row();
        echo json_encode($matakuliah);
    }

    public function getNamaMatkul_dsn_s1_genap()
    {
        $idmatkul = $this->input->post('idmatkul');
        $string = explode('-', $idmatkul);
        $kode_mk = $string[0];
        $kelas_mk = $string[1];
        $matakuliah = $this->db->select('*')->from('matkul_s1_20212')
            ->join('jadwal_s1_20212', 'jadwal_s1_20212.kode_mk=matkul_s1_20212.kode_mk')
            ->join('dosen', 'dosen.id_dsn = jadwal_s1_20212.id_dsn')
            ->where('jadwal_s1_20212.kode_mk', $kode_mk)->where('jadwal_s1_20212.kelas', $kelas_mk)->where('jadwal_s1_20212.id_dsn', $this->session->userdata('nip'))->get()->first_row();
        echo json_encode($matakuliah);
    }
