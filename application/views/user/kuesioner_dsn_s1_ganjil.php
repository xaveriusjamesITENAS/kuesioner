        ...
        <div class="page-container">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong class="card-title">Kuesioner Pembelajaran dan Suasana Akademik S1 Ganjil</strong>
                                    </div>
                                    ...
                                    <div class="card-body card-block">
                                        <?= form_open('user/kuesioner_dsn_s1_ganjil'); ?>
            ...
            <script>
                ...
                $(document).on('change', '#pilihmatkul', function(e) {
                    ...
                    $.ajax({
                        url: "<?php echo site_url('user/getNamaMatkul_dsn_s1_ganjil'); ?>",
                        type: 'POST',
                        data: {
                            idmatkul: idmatkul,
                        },
