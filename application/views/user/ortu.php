        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="title">Data Orangtua - Ibu</h5>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4 pr-1">
                            <?= form_open_multipart('user/data_ortu'); ?>
                            <div class="form-group">
                                <label>NIK (No.KTP) Ibu</label>
                                <input type="text" class="form-control" placeholder="NIK (No.KTP) Ibu" name="nik_ibu" value="<?= $user['nik_ibu'] ?>">
                            </div>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8 pl-1">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nama Lengkap Ibu" name="nama_ibu" value="">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4 pr-1">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" placeholder="Tgl.Lahir" id="tgllahir_ibu" name="tgllahir_ibu" value="">
                            </div>
                        </div>
                        <div class="col-md-4 px-1">
                            <div class="form-group">
                                <label>Umur</label>
                                <input type="text" class="form-control" placeholder="Umur" id="umur_ibu" name="umur_ibu" value="">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 pr-1">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Instansi" id="instansi_ibu" name="instansi_ibu" value="">
                            </div>
                        </div>
                        <div class="col-md-4 px-1">
                            <div class="form-group">
                                <label>Jenis Pekerjaan</label>
                                <input type="text" class="form-control" placeholder="Jenis Pekerjaan" id="pekerjaan_ibu" name="pekerjaan_ibu" value="">
                            </div>
                        </div>
                        <div class="col-md-4 pl-1">
                            <div class="form-group">
                                <label>No. Handphone</label>
                                <input type="text" class="form-control" placeholder="No.Handphone" id="nohp_ibu" name="nohp_ibu" value="">
                            </div>
                        </div>
