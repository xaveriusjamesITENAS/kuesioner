                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong class="card-title">Kuesioner Karyawan/ TenDik</strong>
                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div>
                                                            <ol class="vue-ordered">
                                                                <li>
                                                                    Kepuasan terhadap layanan pengelolaan dan pengembangan SDM.
                                                                </li>
                                                                <li>Kepuasan terhadap sarana prasarana</li>
                                                            </ol>
                                                            <p>Mohon Saudara/i untuk memberikan respon sesuai dengan keadaan sebenarnya.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
