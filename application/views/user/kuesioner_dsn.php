        ...
        <div class="col-md-12">
            <div class="card ">
                ...
                <div class="card-body ">
                    ...
                    <div class="row">
                        <div class="col-lg-10">
                            <?= form_open_multipart('user/kuesioner_dsn'); ?>
                            <div class="form-group row">
                                <label for="nrpmhs" class="col-sm-2 col-form-label">NIP Dosen</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nip" name="nip" value="<?= $this->session->userdata('nip'); ?>" disabled readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="pin" name="pin" value="<?= $this->session->userdata('nama_dsn'); ?>" disabled readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" aria-label=".form-select-sm example" id="pilihmatkul">
                                        <option>Pilih Kode Matakuliah</option>
                                        <?php foreach ($matkul as $mtk) { ?>
                                            <option value="<?= $mtk->kode_mk ?>"><?= $mtk->kode_mk ?> - <?= $mtk->kelas ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="namamk" name="namamk" value="" disabled readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="kelas" name="kelas" value="" disabled readonly>
                                </div>
                            </div>
                            ...
                            foreach ($pertanyaan as $prt) : ?>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <p class="form-control" aria-label="Disabled input example" disabled readonly><?= $prt['pertanyaan']; ?></p>
                                        <div class="form-check">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <textarea rows="4" cols="80" class="form-control" placeholder="" value="Saran"></textarea>
                                </div>
                            </div>
