                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong class="card-title">Kuesioner Karyawan</strong>
                                    </div>
                                    <?= $this->session->flashdata('message'); ?>
                                    <div class="card-body">
                                        <div class="typo-headers">
                                            <h1 class="pb-2 display-5" style="font-size: 25px;">Instrumen Penilaian Efektivitas Proses Pembelajaran Online</h1>
                                        </div>
                                        <div class="typo-articles">
                                            <p>
                                                Kuesioner ini menanyakan pendapat anda mengenai pembelajaran daring selama semester ini. Pengumpulan data menggunakan kuesioner ini bertujuan mengukur keefektifan kegiatan belajar daring yang telah dilakukan. Berikan tanggapan berdasarkan pendapat sendiri dan bukan pandangan/pendapat orang lain. Kami mengucapkan banyak terima kasih atas partisipasinya dalam pengisian kuesioner ini.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="card-body card-block">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                ...
                                                <!-- <input type="text" class="form-control-static" readonly placeholder="NIP Karyawan" name="nip" value="<?= $this->session->userdata('nip'); ?>"> -->
                                                <input type="text" class="form-control-static" id="id_dsn" name="id_dsn" value="<?= $this->session->userdata('nip'); ?>">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                ...
                                                <!-- <input type="text" class="form-control-static" placeholder="Nama Karyawan" name="nama_dsn" value="<?= $this->session->userdata('nama_dsn'); ?>"> -->
                                                <input type="text" class="form-control-static" id="passw_dsn" name="passw_dsn" value="<?= $this->session->userdata('nama_dsn'); ?>" readonly>
                                            ...
                                            <div class="col-12 col-md-6">
                                                <!-- <select class="form-control" aria-label=".form-select-sm example" name="kode_mk" id="pilihmatkul">
                                                    ...
                                                    <?php foreach ($matkul as $mtk) { ?>
                                                        <option value="<?= $mtk->kode_mk ?>"><?= $mtk->kode_mk ?> - <?= $mtk->nama_dsn ?></option>
                                                    <?php } ?>
                                                </select> -->
                                                <select class="form-control" aria-label=".form-select-sm example" name="kode_mk" id="pilihmatkul">
                                                    <option>Pilih Kode Matakuliah</option>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <!-- <input type="text" class="form-control-static" placeholder="" id="namamk" name="namamk" readonly> -->
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <!-- <input type="text" class="form-control-static" placeholder="" id="kelas" name="kelas"> -->
