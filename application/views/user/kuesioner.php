				...
				<div class="card-body ">
					...
					<div class="row">
						<div class="col-lg-10">
							...
							<div class="form-group row">
								<label for="nrpmhs" class="col-sm-2 col-form-label">NRP Mahasiswa</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="nrpmhs" name="nrpmhs"
										value="<?= $this->session->userdata('nrp'); ?>" readonly>
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<select class="form-control" aria-label=".form-select-sm example" name="kode_mk"
										id="pilihmatkul">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<label readonly class="form-control-plaintext" style="color: red">Kuesioner ini
										terdiri dari 12 butir pertanyaan dengan bentuk jawaban pilihan ganda yang
										terdiri dari 4 (empat) pilihan jawaban. Anda dapat memilih satu pilihan sesuai
										pendapat pribadi.</label>
									<div class="form-check">
										<input class="form-check-input" type="radio" name="flexRadioDisabled"
											id="flexRadioDisabled" style="color: red" disabled>
									...
									<div class="form-check">
										<input class="form-check-input" type="radio" name="flexRadioDisabled"
											id="flexRadioCheckedDisabled" style="color: red" disabled>
									...
									<div class="form-check">
										<input class="form-check-input" type="radio" name="flexRadioDisabled"
											id="flexRadioDisabled" style="color: red" checked disabled>
										<label class="form-check-label" for="flexRadioDisabled" style="color: red">
											Baik (Puas)
										</label>
									</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									...
									<p class="form-control" aria-label="Disabled input example" readonly>
										<?= $prt['pertanyaan']; ?></p>
									<div class="form-check">
										<input class="form-check-input" type="radio" name="<?= $name . $no_radio1++ ?>"
									...
									<div class="form-check">
										<input class="form-check-input" type="radio" name="<?= $name . $no_radio2++ ?>"
									...
									<div class="form-check">
										<input class="form-check-input" type="radio" name="<?= $name . $no_radio3++ ?>"
											id="flexRadioDisabled" value="3">
										<label class="form-check-label" for="flexRadioDisabled">
											Baik (Puas)
										</label>
									</div>
									<div class="form-check">
										<input class="form-check-input" type="radio" name="<?= $name . $no_radio4++ ?>"
											id="flexRadioCheckedDisabled" value="4">
										<label class="form-check-label" for="flexRadioCheckedDisabled">
											Sangat Baik (Sangat Puas)
										</label>
									</div>
