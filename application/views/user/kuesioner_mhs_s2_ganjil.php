...
<head>
	...
	<!-- Title Page-->
	<title>Kuesioner Mahasiswa S2 2021/1 | Institut Teknologi Nasional</title>
		...
		<div class="page-container">
							...
							<div class="col-md-12">
								<div class="card">
									...
									<div class="card-body card-block">
										<?= form_open('user/kuesioner_mhs_s2_ganjil'); ?>
										...
										<div class="row form-group">
											<div class="col col-md-3">
												<label class=" form-control-label" style="color:green; font-weight:bold">Petunjuk
													Pengisian</label>
											</div>
										...
										<div class="row form-group">
											...
											<div class="col-12 col-md-9">
												<textarea name="saran" id="textarea-input" rows="9" value="saran" placeholder="Berikan saran anda mengenai kendala utama dalam Pembelajaran dan Suasana Akademik." class="form-control"><?= set_value('saran') ?></textarea>
												<?= form_error(
													'saran',
													'<small class="text-danger pl-3">',
													'</small>'
			...
			<script>
				...
				$(document).on('change', '#pilihmatkul', function(e) {
					...
					$.ajax({
						url: "<?php echo site_url('user/getNamaMatkul_s2_ganjil'); ?>",
						type: 'POST',
						data: {
							idmatkul: idmatkul,
						},
