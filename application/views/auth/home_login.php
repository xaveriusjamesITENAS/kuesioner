      ...
      <div class="signin-signup">
        <form method="post" action="" class="sign-in-form">
          <h1 class="title" style="color: green; font-size:medium">
            ...
            <a type="submit" class="btn btn-block login-btn mb-4" href="<?= base_url('auth/index_dsn'); ?>" style="text-align: center; line-height: 2.75em;">Dosen</a>
            <a type=" submit" class="btn btn-block login-btn mb-4" href="<?= base_url('auth/index_mhs'); ?>" style="text-align: center; line-height: 2.75em;">Mahasiswa</a>
        </form>
      </div>
    </div>
